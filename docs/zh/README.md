...
| 宸ュ叿 | 鐗圭偣 | 涓嬭浇 |
|------|------|------|
| [**Clash for Windows**](https://clash-for-windows.net) | 鍥惧舰鍖栫晫闈紝鏀寔瑙勫垯鍒嗘祦锛屾渶娴佽 | [涓嬭浇](https://clash-for-windows.net/download) |
| Clash Verge | 寮€婧愬厤璐癸紝Rust閲嶅啓锛岃交閲忕骇 | [GitHub](https://github.com/clash-verge-rev/clash-verge-rev) |
| v2rayN | 鏀寔澶氬崗璁紝鍔熻兘鍏ㄩ潰 | [GitHub](https://github.com/2dust/v2rayN) |

### macOS

| 宸ュ叿 | 鐗圭偣 | 涓嬭浇 |
|------|------|------|
| [**Clash for Windows Mac鐗?*](https://clash-for-windows.net) | 涓嶹indows鐗堜綋楠屼竴鑷?| [涓嬭浇](https://clash-for-windows.net/download) |
| ClashX Pro | 鍘熺敓macOS浣撻獙锛岃彍鍗曟爮闆嗘垚 | [GitHub](https://github.com/yichengchen/clashX) |

### Linux

| 宸ュ叿 | 鐗圭偣 | 涓嬭浇 |
|------|------|------|
| Clash Verge | 璺ㄥ钩鍙版敮鎸侊紝鐣岄潰鐜颁唬 | [GitHub](https://github.com/clash-verge-rev/clash-verge-rev) |
| Clash for Windows | 閫氳繃Wine杩愯 | [鏁欑▼](https://clash-for-windows.net/linux) |
...
- [**绉戝涓婄綉鏂版墜鎸囧崡**](https://github.com/clashhub-net/clash-vpn-guide) - 浠庨浂寮€濮嬬殑瀹屾暣鏁欑▼
- [Clash 瑙勫垯閰嶇疆璇﹁В](https://lancellc.gitbook.io/clash/) - 瀹樻柟鏂囨。
- [璁㈤槄杞崲鏁欑▼](subscription-converter.md) - 鍚勭鏍煎紡浜掕浆

### 杩涢樁鎶€宸?
- [鑷畾涔夎鍒欏垎娴乚(custom-rules.md) - 绮剧粏鍖栨帶鍒舵祦閲忚蛋鍚?- [TUN 妯″紡閰嶇疆](tun-mode.md) - 鍏ㄥ眬浠ｇ悊锛屾敮鎸佹洿澶氬簲鐢?- [鑴氭湰澧炲己](script-enhancement.md) - 鑷姩鍒囨崲銆佽礋杞藉潎琛?
### 娴佸獟浣撹В閿?
- [Netflix 瑙ｉ攣妫€娴媇(netflix-check.md)
- [Disney+/HBO Max/Amazon Prime 瑙ｉ攣鎸囧崡](streaming-unlock.md)
- [ChatGPT 涓撶敤鑺傜偣閰嶇疆](chatgpt-config.md)
...
| 宸ュ叿 | 璇存槑 | 閾炬帴 |
|------|------|------|
| subconverter | 鏈€娴佽鐨勮闃呰浆鎹㈠伐鍏?| [GitHub](https://github.com/tindy2013/subconverter) |
| ACL4SSR 鍦ㄧ嚎杞崲 | 鍏嶈垂鍦ㄧ嚎杞崲锛岃鍒欎赴瀵?| [鍦ㄧ嚎鐗圿(https://acl4ssr-sub.github.io/) |

### 棰勮瑙勫垯

```yaml
# 绀轰緥锛氬箍鍛婃嫤鎴?+ 鍥藉唴鐩磋繛 + 鍥藉浠ｇ悊
Rule:
...
| 宸ュ叿 | 鐗圭偣 | 涓嬭浇 |
|------|------|------|
| Clash for Android | 寮€婧愬厤璐癸紝鐣岄潰鍙嬪ソ | [GitHub](https://github.com/Kr328/ClashForAndroid) |
| v2rayNG | 杞婚噺绾э紝鏀寔澶氬崗璁?| [GitHub](https://github.com/2dust/v2rayNG) |
...
- [ACL4SSR/ACL4SSR](https://github.com/ACL4SSR/ACL4SSR) - 閫傞厤Clash鐨勮鍒欓泦
...
4. 閲嶆柊涓嬭浇鏈€鏂扮増鏈?
璇︾粏鎺掓煡锛歔鏁呴殰鎺掗櫎鎸囧崡](troubleshooting.md)
</details>
...
3. 鎻愪氦鏇存敼 (`git commit -m 'Add new resource'`)
4. 鎺ㄩ€佸埌鍒嗘敮 (`git push origin feature/add-resource`)
5. 鍒涘缓 Pull Request
